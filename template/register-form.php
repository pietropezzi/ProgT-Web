<script src="js/checkRegisterForm.js"></script>
 <div class="my-4 text-white register">
    ...
    <div class="">
        <form name="registrazione" action="registrazione.php" onsubmit="return checkRegisterForm()" method="post" action="#">
            <div class="user-details">
                ...
                <div class="input-box">
                    ...
                    <input id="psw" name="password" type="password" placeholder="Enter your password" required>
                </div>
                <div class="input-box">
                    <label class="mb-1" for="username">Verifica Password</label><br>
                    <input id="psw2" name="password2" type="password" placeholder="Confirm your password" required>
                </div>
            </div>
            <div>
